              ...
              <div key={p.Id} className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs mt-1">
                    {p.DamageDone > 0 && <span className="text-red-400 font-mono">{Math.round(p.DamageDone)} {t('damage')}</span>}
                    {p.SupportHealingDone > 0 && <span className="text-green-400 font-mono">{Math.round(p.SupportHealingDone)} {t('healing')}</span>}
                  </div>
                </div>
              </div>
            ))}
